                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <div className="col-md-5">
                        <form className="d-flex">
                            ...
                            <button className="btn btn-outline-primary mx-1" type="submit">جستوجو</button>
                        </form>
                    </div>
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-item dropdown">
                            ...
                            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                                <ul>
                                    ...
                                    <li><Link to="/mobileaccessories" className="dropdown-item text-dark" href="#">لوازم جانبی موبایل</Link></li>
                                    <li><Link to="/cosmetics" className="dropdown-item text-dark" href="#">لوازم آرایشی و بهداشتی</Link></li>
                                    <li><Link to="/stationery" className="dropdown-item text-dark" href="#">لوازم تحریر</Link></li>
                                </ul>
                                <ul>
                        ...
                        <li className="nav-item2">
                            ...
                            <Link to="/ContactUs" target="_blank" className="nav-link" id="btn-link-ContactUs_id" href="#"><button className="bg-primary text-white"><i className="bi bi-person-circle px-1"></i>تماس با ما</button></Link>
                        </li>
